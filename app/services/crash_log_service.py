...
def ingest_crash_log(payload: dict, *, auth_username: str | None = None):
    ...
    crash_log = crash_log_repository.create_crash_log(
        ...
        username_snapshot=auth_user.username if auth_user else fallback_username,
...
def _serialize_crash_log_min(crash_log, *, include_stack: bool = False):
    ...
    payload = {
        ...
        "username": crash_log.username_snapshot,
...
def list_crash_logs_for_admin(
    *,
    ...
    return {
        ...
        "total": total,
        "crash_logs": [
            _serialize_crash_log_min(crash_log, include_stack=False)
